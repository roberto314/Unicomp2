...
ASS=../../../various/assembler/a68
#ASS=../../../various/assembler/as0
#ASS=../../../various/assembler/as1
#ASS=../../../various/assembler/as11
#ASS=../../../various/assembler/as1h
#ASS=../../../various/assembler/as4
#ASS=../../../various/assembler/asl
#ASS=../../../various/assembler/ca65


#DIR="/home/rob/Projects/mc-6502_mini/"
PWD=`pwd`
echo $PWD
${ASS} ${NAME}.asm -l ${NAME}.lst -o ${NAME}.s19
#srec_cat ${NAME}.s19 -Intel -o ${NAME}.bin -binary
srec_cat ${NAME}.s19 -Intel -offset -0xE000 -o ${NAME}.bin -binary # strip first 0x20 bytes
