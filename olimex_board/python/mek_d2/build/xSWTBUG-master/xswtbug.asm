...
;
EXTENDED	equ	false ;true
;
; These are options if EXTENDED is on...
;
SD_SUPPORT	equ	false ;true	;include SD card funcs
SD_CMDS		equ	false ;true	;adds SD card commands
SD_BOOT		equ	false ;true	;boot from SD card
BOOT_ADDR	equ	$a100	;where boot sector goes
;
NUMGUESS		equ	false ;true	;include NumGuess game
MEMTEST		equ	false ;true	;include Memory tester
OTHELLO		equ	false ;true	;include Othello game
;
...
PROM		equ	$F000	;JUMP TO PROM ADDRESS
STACK_SIZE	equ	$2b
		page
;***************************************************
; RAM
